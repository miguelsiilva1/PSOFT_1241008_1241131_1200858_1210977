...
@UseCase
public class TopAircraftsByFlightHoursUseCase {
    private final AircraftRepository aircraft_repo;

    public TopAircraftsByFlightHoursUseCase(AircraftRepository aircraft_repo) {
        this.aircraft_repo = aircraft_repo;
    }

    public List<Aircraft> execute() {
        return aircraft_repo.findTop5ByFlightHours(PageRequest.of(0, 5));
    }
}
