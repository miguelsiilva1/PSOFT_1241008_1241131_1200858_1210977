...
public class RegisterAircraftUseCase {
    ...
    public Aircraft execute(String registration_number,
        ...
        Aircraft aircraft = register_aircraft_service.register(aircraft_registration, aircraft_model_object, manufacturing_date, last_maintenance, max_flight_hours_until_maintenance, max_days_until_maintenance, seating_configuration, aircraft_status);
